...
<head>
<meta charset="UTF-8">
<title>Cookie Review Update</title>
		...
		<div id="popWrap" style="width: 660px;">
			...
			<div class="popBody_con">
				<div class="reviewWrap">
					<div class="write">
						<table summary="상품후기 수정">
							<caption>상품후기 수정</caption>
							<colgroup>
								...
								<tr>
									...
									<td>
										...
										<!-- 클릭했을 때 class에 good 추가 -->
											...
											<!-- 별 클릭했을 때 value 값 변경 -->
											<input type="hidden" name="star" id="star" value="${update.star}">
											<!-- 별 클릭했을 때 내용 변경 -->
								...
								<tr>
									...
									<td>
										<div class="form-group">
											...
											<textarea name="contents" class="form-control" id="contents" rows="10" cols="80" placeholder="Enter Cotents">${update.contents}</textarea>
										</div>
									</td>
								</tr>
								<tr>
									...
									<td>
										...
										<div>
											<ul>
												<c:forEach items="${update.reviewFilesVO}" var="file" varStatus="i">
													<li>
...
<script type="text/javascript">
   ...
   var lv = $('input[name="star"]').val();
	$('#'+lv).addClass('good').prevAll('button').addClass('good');
	$('.star_cont').text($('#'+lv).children().text());
