...
<body>
	  ...
	  <div class="container">
		  ...
		  <ul class="nav nav-tabs">
		  		<li class="active"><a data-toggle="tab" href="#pmember">개인회원</a></li>
		  		<li><a data-toggle="tab" href="#bmember">사업자회원</a></li>
		  </ul>
		  
		  <div class="tab-content">
		   <!-- member  -->
		    <div id="pmember" class="tab-pane fade in active">
					<div class="container">
			...
			<!--검색창  -->
			<form action="adminMemberList" id="frm">
	...
	<script type="text/javascript">
		...
		$('#memDel').click(function(){
		   ...
		   <!--business member  -->
		    <div id="bmember" class="tab-pane fade">
		      	<div class="container">
		...
		<div class="container">
		<button class="btn btn-danger del" id="memDel2">delete</button>
		</div>
		...
		<!--검색창  -->
		<form action="adminMemberList" id="frm2">
			<input type="hidden" id="curPage" value="1" name="curPage" >
...
// 		    $("#pmember").load("./pmemberList");
// 		    $("#bmember").load("./bmemberList");
// 		});
		</script>
